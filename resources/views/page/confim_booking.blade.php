...
@include('components.nav-bar')
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Resrvation</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="/">Accueil</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Resrvation</h6>
        </div>
    </div>
    <!-- Page Header Start -->
		...
		<div class="container pb-60">
			<div class="row">
				<div class="col-md-12 text-center">
					<h2 class="text-success">Merci pour votre reservation</h2>
                    <p>Un message de confirmation vous serra envoyé</p>
                    <a href="/" class="btn btn-primary  text-white">Cliquer pour continuer</a>
				</div>
			</div>
		</div><!--end container-->
